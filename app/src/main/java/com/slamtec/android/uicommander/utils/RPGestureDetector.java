...
/**
 * Created by Alan on 10/15/15.
 */
public class RPGestureDetector {
    private final static String TAG = "RPGestureDetector";
    ...
    public RPGestureDetector(OnRPGestureListener mListener) {
